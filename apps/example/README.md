...
- `vercel.json` configures the Hono framework and `includeFiles` so the deployment includes `app/**/*` plus installed plugin package manifests and skills in the function bundle; regenerated by `junior snapshot create` at build time
