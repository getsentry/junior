...
- `specs/conversation-metadata-storage.md`
...
- `specs/conversation-metadata-storage.md` owns SQL-backed queryable conversation metadata, transcript-storage exclusions, and Vercel-safe migration/backfill behavior.
