...
- Runtime mints GitHub App installation tokens from the permissions already approved on the installation. Manifest capability growth must not make unrelated GitHub workflows fail before the actual command runs.
