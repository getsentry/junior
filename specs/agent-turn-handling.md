...
3. Slack side effect satisfies the turn:
   ...
   - A successful `sendMessage` call with no visible final assistant text also satisfies the turn, because the requested channel message has already been delivered.
