...
- `app.ai.reasoning_tokens` (when the provider reports a reasoning breakdown)
- `app.ai.cost.input_usd` (when pi-ai reports estimated cost)
- `app.ai.cost.output_usd` (when pi-ai reports estimated cost)
- `app.ai.cost.cache_read_usd` (when pi-ai reports estimated cost)
- `app.ai.cost.cache_write_usd` (when pi-ai reports estimated cost)
- `app.ai.cost.total_usd` (when pi-ai reports estimated cost)
