...
- System actors may carry an explicit user credential subject only from a runtime boundary that issued or verified a subject binding for that action, such as trusted dispatch verifying a core-signed Slack DM binding before storing the subject.
