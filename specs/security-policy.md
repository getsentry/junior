...
- Proxied sandbox egress requests must verify Vercel Sandbox OIDC audience, project, and sandbox claims, resolve the provider from the forwarded host, and require a requester-bound sandbox egress session for that provider.
