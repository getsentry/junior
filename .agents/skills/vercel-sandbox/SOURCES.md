...
| `packages/junior/src/chat/app/production.ts`                                              | canonical  | high       | Production timeout and continuation wiring                                                                        | Repo implementation                                         |
...
| `packages/junior/src/chat/agent/index.ts`                                                 | canonical  | high       | Turn timeout detection and abort behavior                                                                         | Repo implementation                                         |
| `packages/junior/src/chat/agent/resume.ts`                                                | canonical  | high       | Timeout continuation persistence                                                                                  | Repo implementation                                         |
...
| `packages/junior/src/chat/runtime/README.md`                                              | canonical  | high       | Timeout-safe multi-run continuation contract                                                                      | Runtime ownership documentation                             |
| `packages/junior/src/chat/sandbox/README.md`                                              | canonical  | high       | Runtime dependency snapshots vs sandbox workspace lifecycle                                                       | Sandbox ownership documentation                             |
...
| Emphasize that snapshots are not workspace durability                                      | adopted  | sandbox README + stable SDK docs + installed `snapshot()` contract                          |
