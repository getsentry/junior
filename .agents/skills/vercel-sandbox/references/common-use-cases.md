...
| First checks                                                                   | Local files                                                                                                                                                                                      | Likely conclusion                                                                                 |
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| Does the runtime persist timeout continuation state and enqueue a resumed run? | `packages/junior/src/chat/agent/index.ts`, `packages/junior/src/chat/agent/resume.ts`, `packages/junior/src/chat/runtime/agent-continue-runner.ts`, `packages/junior/src/chat/runtime/README.md` | Separate sandbox reuse failures from agent continuation failures before changing either lifecycle |
