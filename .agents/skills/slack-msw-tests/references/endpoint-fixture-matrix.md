...
| `src/chat/slack/tools/canvas/*`                  | `canvases.create`, `canvases.access.set`, `canvases.edit`, `files.info`, `files.slack.com/*`                       | `canvasesCreateOk`, `canvasesAccessSetOk`, `canvasesEditOk`, `filesInfoOk`                                                    | `getCapturedSlackApiCalls(method)`, `queueSlackPrivateFileDownload(...)` |
| `src/chat/slack/tools/list/*`                    | `slackLists.create`, `slackLists.items.create`, `slackLists.items.list`, `slackLists.items.update`, `files.info`   | `slackListsCreateOk`, `slackListsItemsCreateOk`, `slackListsItemsListPage`, `slackListsItemsUpdateOk`, `filesInfoOk`          | `getCapturedSlackApiCalls(method)`                                       |
