...
describe("reporting-window six-hour buckets", () => {
  ...
  it("snaps six-hour buckets to 00/06/12/18 UTC", () => {
    ...
    expect(startOfUtcSixHour(Date.parse("2026-06-15T00:00:00.000Z")).toISOString()).toBe(
      "2026-06-15T00:00:00.000Z",
    );
    expect(startOfUtcSixHour(Date.parse("2026-06-15T05:59:00.000Z")).toISOString()).toBe(
      "2026-06-15T00:00:00.000Z",
    );
    expect(startOfUtcSixHour(Date.parse("2026-06-15T18:01:00.000Z")).toISOString()).toBe(
