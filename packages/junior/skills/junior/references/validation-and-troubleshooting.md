...
| `oauth requires credentials`                                                              | OAuth block has no credential delivery config.                                                                 | Add `credentials.type: oauth-bearer`, or `github-app` for GitHub user-to-server write auth.                |
| `oauth requires credentials.type "oauth-bearer" or "github-app"`                          | OAuth was paired with unsupported credentials.                                                                 | Use bearer OAuth credentials, GitHub App credentials, or remove `oauth`.                                   |
