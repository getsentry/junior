...
/** Create a tool that searches saved Junior transcripts visible from the current source. */
export function createTranscriptSearchTool(
  ...
  return tool({
    description:
      "Search saved Junior conversation transcripts by keyword within the current source visibility. Public workspace channels may be visible; private, direct, and local transcripts are limited to the current source.",
