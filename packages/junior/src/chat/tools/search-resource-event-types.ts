...
export function createSearchResourceEventTypesTool(
  ...
  return zodTool({
    ...
    description:
      "Search the resource event types currently enabled by plugins without creating anything. Use watchResourceEvents to receive temporary updates in the current Slack thread. This tool does not watch a resource or enumerate concrete resources.",
    inputSchema: z
      .object({
        query: z
          .string()
