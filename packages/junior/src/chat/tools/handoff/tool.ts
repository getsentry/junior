...
export function createHandoffTool(
  ...
  return zodTool({
    ...
    description: [
      ...
      "A successful handoff becomes the active profile for later turns. For a new request, return to a profile for routine work when its description fits, even if earlier work needed a different profile.",
      `Available profiles:\n${profileList}`,
    ].join(" "),
