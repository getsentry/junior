...
function deserializeMessage(message: ThreadMessagePayload["message"]): ChatMessage {
...
export async function logThreadMessageFailure(payload: ThreadMessagePayload, errorMessage: string): Promise<void> {
  logError(
