 ...
 *
 * Delivery can dual-write the assistant before timeout recovery parks. The next
 * wake must complete that turn instead of asking the model to continue from a
