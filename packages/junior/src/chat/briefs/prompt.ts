...
- An open decision is a choice someone still has to make. Phrase it as the choice and include its options when known. Do not use worries, monitoring questions, finished work, or general next steps.
