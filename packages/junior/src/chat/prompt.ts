...
const TOOL_POLICY_RULES = [
  ...
  "- Repository AGENTS.md files govern their containing directory and descendants. Load applicable files from the repository root through the working directory; deeper instructions take precedence. Re-check when entering a deeper subtree or another repository.",
