...
const TOOL_POLICY_RULES = [
  ...
  "- Repository AGENTS.md files govern their containing directory and descendants. Load applicable files from the repository root through the working directory; AGENTS.override.md replaces AGENTS.md in the same directory, and deeper instructions take precedence. Re-check when entering a deeper subtree or another repository.",
