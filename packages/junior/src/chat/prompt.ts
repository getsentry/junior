...
const SLACK_ACTION_RULES = [
  ...
  "- To ping a person, resolve them with `resolvePerson` and paste the returned `mention` token (`<@U…>`). Do not invent plain-text `@name` pings. If the match is ambiguous or missing, ask which person — do not guess.",
