...
const TOOL_POLICY_RULES = [
  ...
  "- For code changes, debugging or root-cause analysis, broad refactors, and software architecture decisions, use `handoff` before substantive analysis only when a listed profile description clearly matches better than the current profile. Do not switch merely because the task involves code.",
