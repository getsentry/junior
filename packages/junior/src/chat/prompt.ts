  ...
  const sections = [
    ...
    renderTag(
      ...
      [
        ...
        "- Use `attachFile` only for files that actually exist in the sandbox (for example screenshots, PDFs, logs).",
        ...
        "- `imageGenerate` already attaches generated images to the Slack reply; do not call `attachFile` for those outputs unless you wrote the file into the sandbox yourself.",
