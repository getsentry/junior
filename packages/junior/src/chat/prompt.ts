...
const TOOL_POLICY_RULES = [
  ...
  "- When a better-fitting model profile is available, call `handoff` before substantive work using that tool's profile catalog and when/when-not rules; do not invent upgrade criteria outside the tool description.",
