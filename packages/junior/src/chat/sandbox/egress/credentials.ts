 ...
 *
 * Leases are cached on the host by provider grant (and actor for user grants),
 * validated against provider-owned domains, and reused until the provider lease
 * is near expiry. Sandbox context only authorizes the hop.
 */
