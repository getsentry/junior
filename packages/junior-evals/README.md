...
- `timeout_resume`: seeds a durable timeout continuation boundary with an unknown shell-command outcome before the real model runs. Use it to evaluate continuation behavior without wall-clock sleeps.
