...
/**
 * Fetch normalized Notion content for a specific page or data source selected by the LLM.
 *
 * This script is intentionally content-focused. Given a concrete Notion object id and type,
 * it returns a stable payload that is easy for the model to summarize: page metadata plus
 * markdown for pages, or schema plus representative rows for data sources.
 */
