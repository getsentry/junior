...
function extractionExamples(): string {
  return [
    ...
    "- User says: 'For architecture proposals, I prefer tradeoffs before recommendations.'",
    "  Output requester memory: canonicalFact='Prefers tradeoffs before recommendations in architecture proposals.'.",
    "- User says: 'In support handoffs, escalation owners go before timelines.'",
    "  Output requester memory: canonicalFact='Prefers escalation owners before timelines in support handoffs.'.",
