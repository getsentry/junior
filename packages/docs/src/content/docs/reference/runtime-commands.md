...
- Credentials are fetched for the current actor and turn when sandbox traffic reaches a registered provider domain; they are not kept as ambient chat-session auth.
