...
> **getConversationSubagentTranscript**(`conversationId`, `runId`, `subagentId`): `Promise`\<`ConversationSubagentTranscriptReport`\>

Defined in: [junior/src/reporting.ts:123](https://github.com/getsentry/junior/blob/main/packages/junior/src/reporting.ts#L123)
