...
| `JUNIOR_SCHEDULER_REDIS_URL`                | No          | Redis URL for dedicated scheduler persistence. When set, scheduler state uses this Redis instance instead of the shared runtime state adapter.       |
