...
<section class="jr-integrations" aria-labelledby="jr-integrations-title">
  <header class="jr-integrations-heading">
    <div>
      <span>THE WHOLE TOOL SHED</span>
      <h2 id="jr-integrations-title">MORE TOOLS.<br />SAME THREAD.</h2>
    </div>
    <div class="jr-integrations-summary">
      <p>
        Junior starts in Slack, then digs through the systems your team already
        uses. Pick an integration and put it to work.
      </p>
    </div>
  </header>

<div class="jr-integration-grid">
  <a class="jr-integration-card" href="/extend/sentry-plugin/">
    <img src="/integrations/sentry.svg" alt="" />
    <span>
      <strong>Sentry</strong>
      <small>TELEMETRY</small>
    </span>
  </a>
  <a class="jr-integration-card" href="/extend/github-plugin/">
    <img src="/integrations/github.svg" alt="" />
    <span>
      <strong>GitHub</strong>
      <small>CODE</small>
    </span>
  </a>
  <a class="jr-integration-card" href="/extend/linear-plugin/">
    <img src="/integrations/linear.svg" alt="" />
    <span>
      <strong>Linear</strong>
      <small>ISSUES</small>
    </span>
  </a>
  <a class="jr-integration-card" href="/extend/vercel-plugin/">
    <img src="/integrations/vercel.svg" alt="" />
    <span>
      <strong>Vercel</strong>
      <small>INFRA</small>
    </span>
  </a>
  <a class="jr-integration-card" href="/extend/notion-plugin/">
    <img src="/integrations/notion.svg" alt="" />
    <span>
      <strong>Notion</strong>
      <small>DOCS</small>
    </span>
  </a>
  <a class="jr-integration-card" href="/extend/datadog-plugin/">
    <img src="/integrations/datadog.svg" alt="" />
    <span>
      <strong>Datadog</strong>
      <small>TELEMETRY</small>
    </span>
  </a>
  <a class="jr-integration-card" href="/extend/cloudflare-plugin/">
    <img src="/integrations/cloudflare.svg" alt="" />
    <span>
      <strong>Cloudflare</strong>
      <small>INFRA</small>
    </span>
  </a>
  <a class="jr-integration-card" href="/extend/amplitude-plugin/">
    <img src="/integrations/amplitude.svg" alt="" />
    <span>
      <strong>Amplitude</strong>
      <small>ANALYTICS</small>
    </span>
  </a>
  <a class="jr-integration-card" href="/extend/hex-plugin/">
    <img src="/integrations/hex.svg" alt="" />
    <span>
      <strong>Hex</strong>
      <small>ANALYTICS</small>
    </span>
  </a>
  <a class="jr-integration-card" href="/start-here/slack-app-setup/">
    <img src="/integrations/slack.svg" alt="" />
    <span>
      <strong>Slack</strong>
      <small>WHERE IT STARTS</small>
    </span>
  </a>
</div>

  <a class="jr-integrations-cta" href="/extend/">See every plugin →</a>
</section>
