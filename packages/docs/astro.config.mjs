...
// import starlightTypedoc from "starlight-typedoc"; // disabled for local QA

// const juniorEntryPoints = ["../junior/src/api-reference.ts"]; // disabled for local QA
  ...
  integrations: [
    starlight({
      ...
      plugins: [
        ...
        sentryAgentMarkdown(),
        // starlightTypedoc disabled for local QA
      ],
    }),
  ],
  markdown: {
