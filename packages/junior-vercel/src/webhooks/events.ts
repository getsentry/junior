 ...
 * and emits canonical events for project, target, and commit watches.
 */
...
/** Normalize one verified Vercel delivery into deployment events. */
export function normalizeVercelEvents(args: { body: unknown }): EventInput[] {
