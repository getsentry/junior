...
function ConversationReplyFooter(props: {
  ...
  return (
    <div className="flex w-full min-h-0 max-h-[min(55dvh,24rem)] flex-col overflow-hidden self-end bg-[#050507] px-2 pt-1.5 pb-[max(0.5rem,env(safe-area-inset-bottom))] md:max-h-none md:overflow-visible md:self-auto md:px-7 md:pt-3 md:pb-3">
