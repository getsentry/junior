...
export function TranscriptViewToggle(props: {
  ...
  return (
    <div
      ...
      className="inline-flex items-center gap-0.5 rounded-md border border-dashboard-border-medium bg-dashboard-overlay p-0.5"
      role="group"
    >
      <ViewModeButton
  ...
  return (
    <IconButtonTooltip label={props.label}>
      <Button
        ...
        className={cn(
          "text-dashboard-text-muted",
          props.pressed && "bg-dashboard-fill-stronger text-dashboard-text",
        )}
        onClick={props.onClick}
        size="icon"
      >
