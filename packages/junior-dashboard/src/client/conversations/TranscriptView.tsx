...
function JumpToLatestButton(props: {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-20 z-20 flex justify-center px-3 md:inset-x-auto md:bottom-6 md:right-8 md:justify-end md:px-0">
      <Button
        aria-label={label}
