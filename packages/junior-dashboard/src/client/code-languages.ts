// Keep the supported web languages explicit. Importing Shiki's bundle also
// retains its theme registry. Each grammar below stays in an on-demand chunk.
export const dashboardCodeLanguages = {
