...
export function renderTranscriptMarkdown(props: {
  compact?: boolean;
  text: string;
}): ReactNode {
...
/** Split markdown prose into headings, lists, and hard-break paragraphs. */
export function parseMarkdownProseBlocks(text: string): MarkdownBlock[] {
