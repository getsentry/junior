      ...
      <HoverCard.Portal>
        <HoverCard.Content
          ...
          className={cn(
            ...
            className ??
              "min-w-36 max-w-64 rounded-md border border-dashboard-border-emphasis bg-dashboard-surface-raised px-3 py-2 font-mono text-xs leading-relaxed text-dashboard-text-muted shadow-2xl shadow-dashboard-shadow-heavy",
          )}
...
export function IconButtonTooltip(props: {
  ...
  return (
    <Tooltip
      className="min-w-0 rounded-md border border-dashboard-border-emphasis bg-dashboard-surface-raised px-2.5 py-1.5 font-sans text-xs leading-none text-dashboard-text shadow-2xl shadow-dashboard-shadow-heavy"
      content={props.label}
