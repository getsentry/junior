...
export function LoadingView(props: { label: string }) {
  return (
    ...
    >
      <section className="grid w-full max-w-lg grid-cols-[auto_minmax(0,1fr)] items-center gap-3 rounded-lg border border-dashboard-border-emphasis bg-dashboard-surface-raised p-4">
        <JuniorLogo />
        <div>
