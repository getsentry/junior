    ...
    >
      <section className="grid gap-5">
        ...
        {forgetAction ? (
          ...
          <div className="inline-flex w-fit items-center gap-2 rounded border border-dashboard-border-medium px-3 py-2 font-mono text-xs uppercase tracking-[0.08em] text-dashboard-text-muted">
