...
- Keep the current actor separate from author history, creator metadata, service-principal credentials, destination membership, actor-sensitive credential subjects, and display names.
