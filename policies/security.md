...
- Treat sandbox filesystems and process state as short-lived and untrusted.
...
- Capture security failures with stable classifications and safe identifiers.
  Never capture secret material or unrestricted private content.
