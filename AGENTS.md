...
- `specs/harness-tool-context.md` (context-bound tool targeting and missing-context failure behavior)
...
- `specs/sandbox-snapshots.md` (sandbox dependency snapshot behavior)
- `specs/testing.md` (testing taxonomy and layer boundaries: unit/integration/eval)
- `specs/unit-testing.md` (unit-test scope and mocking boundaries)
- `specs/integration-testing.md` (integration-test scope, real-runtime wiring, and fake-agent seams)
- `specs/eval-testing.md` (agent-facing eval scope, rubrics, and execution boundaries)
- `specs/slack-http-mocking.md` (Slack MSW fixtures, handlers, and HTTP assertion contract)
