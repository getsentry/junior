...
- `specs/context-compaction.md` (reusable Pi history compaction, replacement context epochs, and visible-thread compaction bounds)
- `specs/model-handoff.md` (safe permanent in-place model upgrade contract)
